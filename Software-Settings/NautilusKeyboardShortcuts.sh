...
echo "Setting the 'Activities' Keyboard Shortcut to 'Super/Windows'..."
gsettings set org.gnome.mutter overlay-key "'Super_L'"

# 2. Set the "Show Applications" Keyboard Shortcut to "Super/Windows + S"
echo "Setting the 'Show Applications' Keyboard Shortcut to 'Super/Windows + S'..."
...
echo "Setting the 'Show Desktop' Keyboard Shortcut to 'Super/Windows + D'..."
gsettings set org.gnome.desktop.wm.keybindings show-desktop "['<Super>d']"

# 4. Set the "Home Folder" Keyboard Shortcut to "Super/Windows + E"
echo "Setting the 'Home Folder' Keyboard Shortcut to 'Super/Windows + E'..."
gsettings set org.gnome.settings-daemon.plugins.media-keys home "['<Super>e']"

# 5. Set the "Terminal" Keyboard Shortcut to "Super/Windows + T"
echo "Setting the 'Terminal' Keyboard Shortcut to 'Super/Windows + T'..."
gsettings set org.gnome.settings-daemon.plugins.media-keys terminal "['<Super>t']"

# 6. Set the "Close Window" Keyboard Shortcut to "Alt + F4"
echo "Setting the 'Close Window' Keyboard Shortcut to 'Alt + F4'..."
